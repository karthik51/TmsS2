...
import { ConfirmRideResolver } from './_resolvers/confirm-ride.resolver';
  ...
  { path: ROUTE_PATH.ERROR + '/:id', component: ErrorComponent },
  {
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          {
             path: ROUTE_PATH.EMPLOYEE.REGISTER_VEHICLE,
             component: RegisterVehicleComponent
          },
          {
            path: ROUTE_PATH.EMPLOYEE.CONFIRM_RIDE,
            component: ConfirmRideComponent,
            resolve: {
              openBookings: ConfirmRideResolver
            }
          },
          {
      ...
      },
      {
        ...
        children: [
          {
            path: ROUTE_PATH.CUSTOMER.BOOK_A_RIDE,
            component: BookARideComponent,
            resolve: {
              bookingDetail: BookingResolver,
